...
class ClassifyFst(GraphFst):
    ...
    def __init__(
        ...
        if cache_dir is not None and cache_dir != "None":
            ...
            far_name = "_ja_itn.far"
            if not enable_standalone_number or not enable_0_to_9:
                standalone = int(enable_standalone_number)
                zero_to_nine = int(enable_0_to_9)
                far_name = f"_ja_itn_standalone_{standalone}_zero_to_nine_{zero_to_nine}.far"
            far_file = os.path.join(cache_dir, far_name)
