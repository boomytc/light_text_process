...
class MeasureFst(GraphFst):
    ...
    def __init__(
        ...
        graph_unit_plural |= pynutil.add_weight(
            pynini.cross("km/h", f"kilometers{DAMO_NON_BREAKING_SPACE}per{DAMO_NON_BREAKING_SPACE}hour"),
            -0.1,
        )
        graph_unit |= pynutil.add_weight(
            pynini.cross("km/h", f"kilometer{DAMO_NON_BREAKING_SPACE}per{DAMO_NON_BREAKING_SPACE}hour"),
            -0.1,
        )
