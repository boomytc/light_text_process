...
- The final target is to replace `third_party/fun_text_processing`; do not remove a vendor route until first-party coverage or an explicit retirement decision exists.
