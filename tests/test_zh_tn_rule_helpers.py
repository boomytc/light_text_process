...
class ChineseTNRuleHelperTests(unittest.TestCase):
    def test_zh_tn_helper_verbalizes_ascii_electronic_tokens(self) -> None:
        ...
        self.assertEqual(
            ...
            "IPv6 二零零一冒号零DB八冒号冒号一，ISBN 九七八杠七杠一一一杠一二三四五杠六，"
            "DOI 一零点一零零零斜杠XYZ一二三。",
        )
    ...
    def test_zh_tn_helper_formats_digit_ordinals(self) -> None:
        ...
        self.assertEqual(
            ...
            "日期 二零二六年六月十五日，版本 202606，阈值 x大于等于五，y小于等于十。",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "范围 3到5天，编号 A杠一二三，网速 100mbps，速度 10米每秒。",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "电量 5kwh，容量 五百一十二兆字节，缓存 一百二十八千字节，流量 500ml，电流 二十毫安。",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "利率上行 二十五个基点，信用利差扩大 三点五个基点，用户 1.2万。",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "2026年第三季度收入增长，2026年第四季度展望改善，2026财年预算。",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "访问 www点example点com。时区 UTC加8 和 GMT减5，温度 负十二，增量 正五。",
        )
        self.assertEqual(
            _prepare_zh_tn_input("时长 01:02:03。电话 400-800-1234，账号 6222 1234 5678 9012。"),
            "时长 1小时2分钟3秒。电话 四零零杠八零零杠一二三四，账号 六二二二一二三四五六七八九零一二。",
        )
